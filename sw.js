 ...
 */
const CACHE_VERSION = 'playpal-v1.5.2';
...
const PRECACHE = [
  ...
  './dist/gameData.js?v=1.5.2',
  './dist/gameUtils.js?v=1.5.2',
  './dist/tripUtils.js?v=1.5.2',
  './dist/handicapService.js?v=1.5.2',
  './dist/courseService.js?v=1.5.2',
  './dist/matchEngine.js?v=1.5.2',
  './dist/statsService.js?v=1.5.2',
  './dist/profileService.js?v=1.5.2',
  './dist/roundHistoryService.js?v=1.5.2',
  './dist/sharingService.js?v=1.5.2',
  './dist/migrations.js?v=1.5.2',
  './dist/egt/egtSeedData.js?v=1.5.2',
  './dist/egt/egtHandicap.js?v=1.5.2',
  './dist/egt/egtImporter.js?v=1.5.2',
  './dist/egt/egtScoring.js?v=1.5.2',
  './dist/egt/egtSideGames.js?v=1.5.2',
  './dist/egt/egtPoints.js?v=1.5.2',
  './dist/egt/egtMoney.js?v=1.5.2',
  './dist/egt/egtStandings.js?v=1.5.2',
  './dist/egt/egtStore.js?v=1.5.2',
  './dist/egt/egtPrintable.js?v=1.5.2',
  './dist/egt/egtEngine.js?v=1.5.2',
  './dist/egt/egtBridge.js?v=1.5.2',
  './dist/Shared.js?v=1.5.2',
  './dist/Home.js?v=1.5.2',
  './dist/Setup.js?v=1.5.2',
  './dist/Trackers.js?v=1.5.2',
  './dist/GameTrackers.js?v=1.5.2',
  './dist/LiveScorecard.js?v=1.5.2',
  './dist/ScoreEntry.js?v=1.5.2',
  './dist/Summary.js?v=1.5.2',
  './dist/RoundViewer.js?v=1.5.2',
  './dist/TripDashboard.js?v=1.5.2',
  './dist/StatsScreen.js?v=1.5.2',
  './dist/EgtTournament.js?v=1.5.2',
  './dist/App.js?v=1.5.2',
];
