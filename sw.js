 ...
 */
const CACHE_VERSION = 'playpal-v1.5.0';
...
const PRECACHE = [
  ...
  './dist/gameData.js?v=1.5.0',
  './dist/gameUtils.js?v=1.5.0',
  './dist/tripUtils.js?v=1.5.0',
  './dist/handicapService.js?v=1.5.0',
  './dist/courseService.js?v=1.5.0',
  './dist/matchEngine.js?v=1.5.0',
  './dist/statsService.js?v=1.5.0',
  './dist/profileService.js?v=1.5.0',
  './dist/roundHistoryService.js?v=1.5.0',
  './dist/sharingService.js?v=1.5.0',
  './dist/migrations.js?v=1.5.0',
  './dist/egt/egtSeedData.js?v=1.5.0',
  './dist/egt/egtHandicap.js?v=1.5.0',
  './dist/egt/egtImporter.js?v=1.5.0',
  './dist/egt/egtScoring.js?v=1.5.0',
  './dist/egt/egtSideGames.js?v=1.5.0',
  './dist/egt/egtPoints.js?v=1.5.0',
  './dist/egt/egtMoney.js?v=1.5.0',
  './dist/egt/egtStandings.js?v=1.5.0',
  './dist/egt/egtStore.js?v=1.5.0',
  './dist/egt/egtPrintable.js?v=1.5.0',
  './dist/egt/egtEngine.js?v=1.5.0',
  './dist/egt/egtBridge.js?v=1.5.0',
  './dist/Shared.js?v=1.5.0',
  './dist/Home.js?v=1.5.0',
  './dist/Setup.js?v=1.5.0',
  './dist/Trackers.js?v=1.5.0',
  './dist/GameTrackers.js?v=1.5.0',
  './dist/LiveScorecard.js?v=1.5.0',
  './dist/ScoreEntry.js?v=1.5.0',
  './dist/Summary.js?v=1.5.0',
  './dist/RoundViewer.js?v=1.5.0',
  './dist/TripDashboard.js?v=1.5.0',
  './dist/StatsScreen.js?v=1.5.0',
  './dist/EgtTournament.js?v=1.5.0',
  './dist/App.js?v=1.5.0',
];
