 ...
 */
const CACHE_VERSION = 'playpal-v1.5.5';
...
const PRECACHE = [
  ...
  './dist/gameData.js?v=1.5.5',
  './dist/gameUtils.js?v=1.5.5',
  './dist/tripUtils.js?v=1.5.5',
  './dist/handicapService.js?v=1.5.5',
  './dist/courseService.js?v=1.5.5',
  './dist/matchEngine.js?v=1.5.5',
  './dist/statsService.js?v=1.5.5',
  './dist/profileService.js?v=1.5.5',
  './dist/roundHistoryService.js?v=1.5.5',
  './dist/sharingService.js?v=1.5.5',
  './dist/migrations.js?v=1.5.5',
  './dist/egt/egtSeedData.js?v=1.5.5',
  './dist/egt/egtHandicap.js?v=1.5.5',
  './dist/egt/egtImporter.js?v=1.5.5',
  './dist/egt/egtScoring.js?v=1.5.5',
  './dist/egt/egtSideGames.js?v=1.5.5',
  './dist/egt/egtPoints.js?v=1.5.5',
  './dist/egt/egtMoney.js?v=1.5.5',
  './dist/egt/egtStandings.js?v=1.5.5',
  './dist/egt/egtStore.js?v=1.5.5',
  './dist/egt/egtPrintable.js?v=1.5.5',
  './dist/egt/egtEngine.js?v=1.5.5',
  './dist/egt/egtBridge.js?v=1.5.5',
  './dist/Shared.js?v=1.5.5',
  './dist/Home.js?v=1.5.5',
  './dist/Setup.js?v=1.5.5',
  './dist/Trackers.js?v=1.5.5',
  './dist/GameTrackers.js?v=1.5.5',
  './dist/LiveScorecard.js?v=1.5.5',
  './dist/ScoreEntry.js?v=1.5.5',
  './dist/Summary.js?v=1.5.5',
  './dist/RoundViewer.js?v=1.5.5',
  './dist/TripDashboard.js?v=1.5.5',
  './dist/StatsScreen.js?v=1.5.5',
  './dist/EgtTournament.js?v=1.5.5',
  './dist/App.js?v=1.5.5',
];
