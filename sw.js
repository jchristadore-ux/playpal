 ...
 */
const CACHE_VERSION = 'playpal-v1.19.6';
...
const PRECACHE = [
  ...
  './dist/gameData.js?v=1.19.6',
  './dist/gameUtils.js?v=1.19.6',
  './dist/tripUtils.js?v=1.19.6',
  './dist/handicapService.js?v=1.19.6',
  './dist/courseService.js?v=1.19.6',
  './dist/matchEngine.js?v=1.19.6',
  ...
  './dist/proService.js?v=1.19.6',
  './dist/sharingService.js?v=1.19.6',
  './dist/scorecardImport.js?v=1.19.6',
  './dist/migrations.js?v=1.19.6',
  './dist/egt/egtSeedData.js?v=1.19.6',
  './dist/egt/egtHandicap.js?v=1.19.6',
  './dist/egt/egtImporter.js?v=1.19.6',
  './dist/egt/egtScoring.js?v=1.19.6',
  './dist/egt/egtSideGames.js?v=1.19.6',
  './dist/egt/egtPoints.js?v=1.19.6',
  './dist/egt/egtMoney.js?v=1.19.6',
  './dist/egt/egtMoneySummary.js?v=1.19.6',
  './dist/egt/egtStandings.js?v=1.19.6',
  './dist/egt/egtStore.js?v=1.19.6',
  './dist/egt/egtPrintable.js?v=1.19.6',
  './dist/egt/egtEngine.js?v=1.19.6',
  './dist/egt/egtBridge.js?v=1.19.6',
  './dist/egt/egtSync.js?v=1.19.6',
  './dist/bottomLineProvider.js?v=1.19.6',
  './dist/BottomLine.js?v=1.19.6',
  './dist/Shared.js?v=1.19.6',
  './dist/Home.js?v=1.19.6',
  './dist/AuthScreen.js?v=1.19.6',
  './dist/Setup.js?v=1.19.6',
  './dist/Trackers.js?v=1.19.6',
  './dist/GameTrackers.js?v=1.19.6',
  './dist/LiveScorecard.js?v=1.19.6',
  './dist/ScoreEntry.js?v=1.19.6',
  './dist/Summary.js?v=1.19.6',
  './dist/RoundViewer.js?v=1.19.6',
  './dist/TripDashboard.js?v=1.19.6',
  './dist/StatsScreen.js?v=1.19.6',
  './dist/EgtTournament.js?v=1.19.6',
  './dist/App.js?v=1.19.6',
];
