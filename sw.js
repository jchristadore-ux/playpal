 ...
 */
const CACHE_VERSION = 'playpal-v1.5.3';
...
const PRECACHE = [
  ...
  './dist/gameData.js?v=1.5.3',
  './dist/gameUtils.js?v=1.5.3',
  './dist/tripUtils.js?v=1.5.3',
  './dist/handicapService.js?v=1.5.3',
  './dist/courseService.js?v=1.5.3',
  './dist/matchEngine.js?v=1.5.3',
  './dist/statsService.js?v=1.5.3',
  './dist/profileService.js?v=1.5.3',
  './dist/roundHistoryService.js?v=1.5.3',
  './dist/sharingService.js?v=1.5.3',
  './dist/migrations.js?v=1.5.3',
  './dist/egt/egtSeedData.js?v=1.5.3',
  './dist/egt/egtHandicap.js?v=1.5.3',
  './dist/egt/egtImporter.js?v=1.5.3',
  './dist/egt/egtScoring.js?v=1.5.3',
  './dist/egt/egtSideGames.js?v=1.5.3',
  './dist/egt/egtPoints.js?v=1.5.3',
  './dist/egt/egtMoney.js?v=1.5.3',
  './dist/egt/egtStandings.js?v=1.5.3',
  './dist/egt/egtStore.js?v=1.5.3',
  './dist/egt/egtPrintable.js?v=1.5.3',
  './dist/egt/egtEngine.js?v=1.5.3',
  './dist/egt/egtBridge.js?v=1.5.3',
  './dist/Shared.js?v=1.5.3',
  './dist/Home.js?v=1.5.3',
  './dist/Setup.js?v=1.5.3',
  './dist/Trackers.js?v=1.5.3',
  './dist/GameTrackers.js?v=1.5.3',
  './dist/LiveScorecard.js?v=1.5.3',
  './dist/ScoreEntry.js?v=1.5.3',
  './dist/Summary.js?v=1.5.3',
  './dist/RoundViewer.js?v=1.5.3',
  './dist/TripDashboard.js?v=1.5.3',
  './dist/StatsScreen.js?v=1.5.3',
  './dist/EgtTournament.js?v=1.5.3',
  './dist/App.js?v=1.5.3',
];
