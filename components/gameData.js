...
const FORMAT_INFO = {
  ...
  markeymatch:     { label:'Markey Match',     icon:'⚔️',  desc:'Team match play (1–2 per side) — auto-press when down 2, fresh press at the turn, overall match runs all 18', minPlayers:2, maxPlayers:4 },
};
